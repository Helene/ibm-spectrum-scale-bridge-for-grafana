...
ARG BUILD_ENV=prod
ARG BASE=registry.access.redhat.com/ubi10/ubi:10.2-1781510001
...
ONBUILD RUN LICENSES_DIR=/licenses && \
            ...
            python${PY_VER} -m pip install --no-cache-dir -r /root/requirements_ubi10.txt && \
...
LABEL com.ibm.version="9.1.1-dev"
